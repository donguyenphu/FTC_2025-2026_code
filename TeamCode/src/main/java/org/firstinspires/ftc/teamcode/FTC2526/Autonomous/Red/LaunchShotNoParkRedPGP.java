...
@Autonomous(name="Launch Shot Red: PGP (without to human player)")
public class LaunchShotNoParkRedPGP extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        sorterArtifacts sorterSystem = new sorterArtifacts(modify, rotator, detector, passer, turret, 22, 24, webcamName);
