...
@Autonomous(name="Net Shot Red")
public class NetShotNoParkRed extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        sorterArtifacts sorterSystem = new sorterArtifacts(rotator, detector, passer, turret, -1, 24, webcamName);
