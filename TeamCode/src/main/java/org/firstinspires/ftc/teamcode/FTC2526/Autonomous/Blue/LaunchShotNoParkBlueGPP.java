...
@Autonomous(name="Launch Shot Blue: GPP (without to human player zone)")
public class LaunchShotNoParkBlueGPP extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        sorterArtifacts sorterSystem = new sorterArtifacts(modify, rotator, detector, passer, turret, 21, 20, webcamName);
